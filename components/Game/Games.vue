<template>
    <div>
        <h1 class="text-center uppercase m-12 text-3xl font-bold">Our Esport teams</h1>
        <div class="flex flex-row items-center justify-around">
            <img v-for="game in games" :key="game.name" class="w-52 transition duration-150 ease-out" :class="currentGame==game.name?'':'opacity-50'" :src="`/img/games/${game.img}.png`" alt="" @click="changeGame(game.name)">
        </div>
    </div>
</template>
